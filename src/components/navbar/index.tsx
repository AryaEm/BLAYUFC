...
export default function Nav() {
    return (
        <section className="w-2/5 left-1/2 -translate-x-1/2 h-[8vh] rounded-full top-5 flex justify-center fixed z-50 bg-[#282a37] bg-opacity-50 backdrop-blur overflow-hidden shadow-navbar">
            ...
            <div className="w-1/2 flex Poppins justify-center items-center gap-6 font-medium text-sm text-white">
                ...
                <Link className="hover:scale-110 hover:text-red-500 transition-all" href={''}>Contact</Link>
